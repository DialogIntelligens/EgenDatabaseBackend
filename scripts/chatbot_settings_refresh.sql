...
-- Generated on: 2025-09-26T12:15:38.914Z
-- Found 96 chatbot configurations
...
-- Configuration 1: washworldse
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('washworldse', 'Hej 😊 Vad kan jag hjälpa dig med?🚗', NOW(), NOW());

-- Configuration 2: washworldde
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('washworldde', 'Hallo 😊 Wie kann ich Ihnen helfen?🚗', NOW(), NOW());

-- Configuration 3: washworldno
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('washworldno', 'Hei 😊 Hva kan jeg hjelpe deg med?🚗', NOW(), NOW());

-- Configuration 4: bevco
INSERT INTO chatbot_settings (chatbot_id, flow2_key, flow3_key, apiflow_key, first_message, created_at, updated_at)
VALUES ('bevco', 'product', 'order', 'order', 'Hej 😊 Spørg mig om alt – lige fra produkter til generelle spørgsmål, ordrestatus, eller tips & tricks til drikkevarer og grej 🍹🍾', NOW(), NOW());

-- Configuration 5: skadedyrshop
...
-- Configuration 11: americanwine
INSERT INTO chatbot_settings (chatbot_id, flow3_key, first_message, created_at, updated_at)
VALUES ('americanwine', 'product', 'Hej😊 har du brug for hjælp til at finde den rette vin?🍷', NOW(), NOW());

-- Configuration 12: bevcose
INSERT INTO chatbot_settings (chatbot_id, flow2_key, apiflow_key, first_message, created_at, updated_at)
VALUES ('bevcose', 'product', 'order', 'Hej 😊 Fråga mig om vad som helst – allt från produkter till allmänna frågor, orderstatus eller tips & tricks om drycker och utrustning 🍹🍾', NOW(), NOW());

-- Configuration 13: bodylab
INSERT INTO chatbot_settings (chatbot_id, apiflow_key, created_at, updated_at)
VALUES ('bodylab', 'order', NOW(), NOW());

-- Configuration 14: bodylabfinland
INSERT INTO chatbot_settings (chatbot_id, apiflow_key, created_at, updated_at)
VALUES ('bodylabfinland', 'order', NOW(), NOW());

-- Configuration 15: bodylabnorge
INSERT INTO chatbot_settings (chatbot_id, apiflow_key, created_at, updated_at)
VALUES ('bodylabnorge', 'order', NOW(), NOW());

-- Configuration 16: bodylabsverige
INSERT INTO chatbot_settings (chatbot_id, apiflow_key, created_at, updated_at)
VALUES ('bodylabsverige', 'order', NOW(), NOW());

-- Configuration 17: bolighaven
...
-- Configuration 38: ejendrom
INSERT INTO chatbot_settings (chatbot_id, flow3_key, first_message, created_at, updated_at)
VALUES ('ejendrom', 'product', 'Hej! Spørg mig om boliger, vurdering, eller få hjælp til at finde den rette bolig for dig 🏠😊', NOW(), NOW());

-- Configuration 39: fluenet
INSERT INTO chatbot_settings (chatbot_id, flow3_key, knowledgebase_index_endpoint, flow3_knowledgebase_index, first_message, created_at, updated_at)
VALUES ('fluenet', 'product', 'fluenet-alt', 'fluenet-alt', 'Hej 😊 Jeg kan hjælpe dig med spørgsmål om vores løsninger🪰', NOW(), NOW());

-- Configuration 40: frydensberg
...
-- Configuration 42: gardinexperten
INSERT INTO chatbot_settings (chatbot_id, pinecone_api_key, knowledgebase_index_endpoint, first_message, created_at, updated_at)
...
-- Configuration 43: gavefabrikken
INSERT INTO chatbot_settings (chatbot_id, flow3_key, knowledgebase_index_endpoint, flow3_knowledgebase_index, first_message, created_at, updated_at)
...
-- Configuration 44: gugplanteskole
INSERT INTO chatbot_settings (chatbot_id, flow3_key, pinecone_api_key, knowledgebase_index_endpoint, flow3_knowledgebase_index, first_message, created_at, updated_at)
...
-- Configuration 46: egenhjemmeside
...
-- Configuration 51: jagttegnkurser
INSERT INTO chatbot_settings (chatbot_id, pinecone_api_key, knowledgebase_index_endpoint, first_message, created_at, updated_at)
...
-- Configuration 52: kirurgiklinik
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('kirurgiklinik', 'Hejsa 😊 Spørg mig om alt – lige fra behandling, vejledning til generelle spørgsmål 🦷 Jeg ved utrolig mange ting og vil hellere end gerne hjælpe dig.', NOW(), NOW());

-- Configuration 53: kongenskoreskole
...
-- Configuration 54: koreskolenpaatoppen
INSERT INTO chatbot_settings (chatbot_id, knowledgebase_index_endpoint, first_message, created_at, updated_at)
...
-- Configuration 65: mundret
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('mundret', 'Hej 😊 Spørg mig om alt – lige fra retter og koncept til generelle spørgsmål, eller endda personlige anbefalinger 🥘', NOW(), NOW());

-- Configuration 66: naturbutikken
...
INSERT INTO chatbot_settings (chatbot_id, created_at, updated_at)
VALUES ('pursico', NOW(), NOW());
...
INSERT INTO chatbot_settings (chatbot_id, flow3_key, first_message, created_at, updated_at)
VALUES ('sexshop', 'product', 'Hej, jeg er din digitale wingman eller -woman 😉 Mangler du hjælp? Så spørg løs om produkter, anbefalinger eller bare nogle solide tips & tricks – Jeg ved, hvad der rykker (og vibrerer) 💪', NOW(), NOW());
...
INSERT INTO chatbot_settings (chatbot_id, flow3_key, pinecone_api_key, first_message, created_at, updated_at)
VALUES ('skolenfri', 'skolenfri', 'pcsk_5jmBcT_PypcxuLpuC6aGqQtgLXeaM8Nt9GzPtqyBLtpeDATfZgMiDmVinhCJeLGV1zoPSK', 'Hej 😊 Spørg mig om alt – lige fra undervisning til generelle spørgsmål, eller få personlig vejledning 📚', NOW(), NOW());
...
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('trafikteori', 'Hej😊 Hvad kan jeg hjælpe dig med? Jeg er trænet på teoribogen og undervisningsplanen for kørekort kategori B.', NOW(), NOW());

-- Configuration 89: validahealth
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('validahealth', 'Hej😊 Hvad kan jeg hjælpe dig med?👩‍⚕️', NOW(), NOW());
...
INSERT INTO chatbot_settings (chatbot_id, first_message, created_at, updated_at)
VALUES ('washworld', 'Hej😊 Hvad kan jeg hjælpe dig med?🚗', NOW(), NOW());

-- Configuration 96: yaay
INSERT INTO chatbot_settings (chatbot_id, flow3_key, pinecone_api_key, knowledgebase_index_endpoint, flow3_knowledgebase_index, first_message, created_at, updated_at)

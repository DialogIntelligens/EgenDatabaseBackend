...
import { initializeLivechatRoutes } from './livechatRoutes.js';
...
// Initialize and mount livechat routes
const livechatRoutes = initializeLivechatRoutes(authenticateToken, pool);
